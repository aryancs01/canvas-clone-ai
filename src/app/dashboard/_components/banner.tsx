...
export const Banner = () => {
    ...
    return (
        <div className="text-white aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center rounded-xl bg-gradient-to-r from-[#2e62cb] via-[#0073ff] to-[#3faff5]">
            <div className="banner rounded-full size-28 items-center justify-center bg-white/50">
            ...
            <div className="flex flex-col gap-y-2">
                <h1 className="text-xl md:text-3xl font-semibold">
                    Visualize your ideas with Canva AI
                </h1>
                <p className="text-xs md:text-sm mb-2">
                    Turn Inspiration into design in no time. Simply upload an image or use your own creativity
                </p>
                <Button
